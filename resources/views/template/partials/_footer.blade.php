...
<div class="container">
  ...
  <div class="row">
    ...
    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam.</p>
      <div>
        ...
        <a href="{{ asset ('/feed') }}"><img src="{{ asset ('img/icons/rss.png') }}" width="32" alt="RSS Feed"></a>
    </div>
    </div>
    <div class="col-footer col-md-4 col-xs-6">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="footer-copyright">&copy; 2014 <a href="http://www.vactualart.com/portfolio-item/basica-a-free-html5-template/">Basica</a> Bootstrap HTML Template. By <a href="http://www.vactualart.com">Vactual Art</a>.<a href="http://localhost/dynamique/public/admin/">|     Login     |</a></div>
    </div>
  </div>
</div>
